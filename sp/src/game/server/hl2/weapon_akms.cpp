...
class CWeaponAKMS : public CHLSelectFireMachineGun
{
	DECLARE_CLASS( CWeaponAKMS, CHLSelectFireMachineGun );
	DECLARE_SERVERCLASS();
public:
	CWeaponAKMS();
...
#else
class C_WeaponAKMS : public C_BaseHLCombatWeapon
{
	DECLARE_CLASS(C_WeaponAKMS, C_BaseHLCombatWeapon);
public:
	DECLARE_CLIENTCLASS();
	DECLARE_PREDICTABLE();
	C_WeaponAKMS();
