...
ConVar sk_plr_dmg_gauss("sk_plr_dmg_gauss", "45");
ConVar sk_plr_max_dmg_gauss("sk_plr_dmg_gauss_max", "69");
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponTau::DrawBeam(const Vector &startPos, const Vector &endPos, float width, bool useMuzzle)
{
	CBasePlayer *pOwner = ToBasePlayer(GetOwner());
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponTau::AddViewKick(void)
{
	//Get the view kick
