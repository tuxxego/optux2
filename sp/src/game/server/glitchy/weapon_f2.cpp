...
IMPLEMENT_SERVERCLASS_ST(CWeaponF2, DT_WeaponF2)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_f2, CWeaponF2 );
PRECACHE_WEAPON_REGISTER(weapon_f2);

BEGIN_DATADESC( CWeaponF2 )
END_DATADESC()

acttable_t	CWeaponF2::m_acttable[] = 
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CWeaponF2::Equip( CBaseCombatCharacter *pOwner )
{
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponF2::WeaponRangeAttack1Condition( float flDot, float flDist )
{
#ifdef HL2_EPISODIC
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponF2::WeaponRangeAttack2Condition( float flDot, float flDist )
{
	return COND_NONE;
}
...
// Input  : *pOperator - 
//-----------------------------------------------------------------------------
void CWeaponF2::FireNPCPrimaryAttack( CBaseCombatCharacter *pOperator, bool bUseWeaponAngles )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponF2::Operator_ForceNPCFire( CBaseCombatCharacter *pOperator, bool bSecondary )
{
...
//-----------------------------------------------------------------------------
void CWeaponF2::Operator_HandleAnimEvent( animevent_t *pEvent, CBaseCombatCharacter *pOperator )
{
	switch( pEvent->event )
	{
...
//-----------------------------------------------------------------------------
const Vector& CWeaponF2::GetBulletSpread( void )
{
...
//-----------------------------------------------------------------------------
float CWeaponF2::GetMinRestTime( void )
{
	//if ( IsAlyxInInjuredMode() )
	//	return 1.5f;
...
//-----------------------------------------------------------------------------
float CWeaponF2::GetMaxRestTime( void )
{
	//if ( IsAlyxInInjuredMode() )
	//	return 3.0f;
